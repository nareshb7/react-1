  ...
  return (
    <div style={{display: 'flex', justifyContent: 'center', marginBlock: '10px', background: '#888'}}>
        <div style={{width: '50%'}}>
            ...
            <input type='text' placeholder='Enter Item Name to search' value={searchIpt} onChange={(e)=> setSearchIpt(e.target.value)}  style={{width: '75%', padding:'10px'}} onKeyUp={handleChange}/>
        </div>
        <div style={{width: '40%'}}>
            <select style={{width: '70%', padding: '10px'}} onClick={(e)=> sortFunc(e.target.value)}>
